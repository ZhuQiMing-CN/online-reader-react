...
class Cpicture extends Component {
    ...
    componentDidMount () {
        ...
        categoryList().then(res => {
            if (res.ok === true) {
                this.setState({
                    majorList: res.picture,
                    defaultMajor: res.picture[0],
                    minsList: res.picture[0].mins,
                    defaultMins: res.picture[0].mins[0]
                }, () => {
                    this.getCategoryPictureBook();
                })
            }
        });
    }
