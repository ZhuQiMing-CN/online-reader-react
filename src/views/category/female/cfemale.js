...
class Cfemale extends Component {
    ...
    componentDidMount () {
        ...
        categoryList().then(res => {
            if (res.ok === true) {
                this.setState({
                    majorList: res.female,
                    defaultMajor: res.female[0],
                    minsList: res.female[0].mins,
                    defaultMins: res.female[0].mins[0]
                }, () => {
                    this.getCategoryFemaleBook();
                })
            }
        });
    }
