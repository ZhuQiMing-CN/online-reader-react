    ...
    componentDidMount () {
        ...
        categoryList().then(res => {
            if (res.ok === true) {
                this.setState({
                    majorList: res.press,
                    defaultMajor: res.press[0],
                    minsList: res.press[0].mins,
                    defaultMins: res.press[0].mins[0]
                }, () => {
                    this.getCategoryPressBook();
                })
            }
        });
    }
